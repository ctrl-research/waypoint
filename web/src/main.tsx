...
const router = createRouter({ routeTree: rootRoute.addChildren([indexRoute, loginRoute, tripRoute, printRoute, editorRoute, shareRoute, calendarRoute, statsRoute, settingsRoute]) })
