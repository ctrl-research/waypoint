...
export function LoginPage() {
  ...
  return (
    <div className="mx-auto mt-24 w-full max-w-sm rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 shadow-sm">
      <h1 className="text-2xl font-semibold text-slate-900 dark:text-slate-100">Sign in to Waypoint</h1>
      <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Plan, log, and track your travels.</p>
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full rounded-lg bg-slate-900 dark:bg-slate-100 px-4 py-2 text-sm font-medium text-white dark:text-slate-900 hover:bg-slate-700 dark:hover:bg-slate-300 disabled:opacity-50"
      >
